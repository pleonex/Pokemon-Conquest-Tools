...
namespace AmbitionConquest.IntegrationTests.Texts
{
    ...
    [TestFixtureSource(typeof(TestData), nameof(TestData.TextListFiles))]
    public class IdenticalTextListTests
    {
        string filePath;
        TextListKind kind;

        public IdenticalTextListTests(string filePath, TextListKind kind)
        {
